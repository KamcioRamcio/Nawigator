            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md border border-gray-200">
                ...
                <div className="bg-gray-50 px-6 py-4 rounded-t-xl border-b border-gray-200">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <h2 className="text-lg font-semibold text-gray-900">Utylizacja Sprzętu</h2>
                                <p className="text-sm text-gray-600">{equipment.sprzet_nazwa}</p>
                            </div>
                        </div>
                        <button
                            onClick={onClose}
                ...
                <div className="px-6 py-6">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                        <h3 className="text-sm font-medium text-blue-900 mb-2">Informacje o sprzęcie</h3>
                        <div className="grid grid-cols-2 gap-3 text-sm">
                            <div>
                                <span className="text-blue-700 font-medium">Ilość:</span>
                                <p className="text-blue-900">{equipment.sprzet_ilosc_aktualna}</p>
                            </div>
                            <div>
                                <span className="text-blue-700 font-medium">Data ważności:</span>
                                <p className="text-blue-900">{equipment.sprzet_data_waznosci}</p>
                            </div>
                        </div>
                    </div>
