...
/**
 * OrganizedEquipment Component
 * Displays a list of organized medical equipment, allowing for viewing, searching, adding, editing, and deleting.
...
function OrganizedEquipment() {
    ...
    /**
     * Fetches organized equipment data from the API.
     ...
     * @param {string} field - The field name being updated (e.g., 'sprzet_zgrany_nazwa').
     * @param {string|number|boolean} value - The new value for the field.
     */
            ...
            Object.keys(equipments).forEach(category => {
                ...
                Object.keys(categoryItems).forEach(subcategory => {
                    ...
                    subcategoryItems.forEach(equipment => {
                        initialValues[equipment.sprzet_zgrany_id] = { ...equipment };
                    });
                });
            });
    ...
    /**
     * Adds a new organized equipment item to the backend.
            ...
            <div className="mx-auto bg-white shadow-lg rounded-lg">
                ...
                <div className="">
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-200 sticky top-[180px] z-20">
                        <tr>
                            <th scope="col" className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nazwa Sprzętu</th>
                            <th scope="col" className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Data Ważności</th>
                            <th scope="col" className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Ilość</th>
                            ...
                            return hasCategoryMatches ? (
                                <React.Fragment key={category}>
                                    <tr className="bg-gray-300 text-base md:text-xl">
                                        <td colSpan="5" className="font-bold p-2 md:p-4 bg-slate-500 text-white">{categoryIndex + 1}. {category}</td>
                                    </tr>
                                            ...
                                            <React.Fragment key={subcategory}>
                                                {showSubcategoryName && (
                                                    <tr className="bg-gray-200 text-sm md:text-base">
                                                        <td colSpan="5" className="font-semibold p-2 md:p-4 bg-slate-400 text-white">{subcategoryIndex + 1}. {subcategory}</td>
                                                    </tr>
                                                )}
                                                {subcategoryItems
                                                    ...
                                                    .map(equipment => (
                                                        <tr key={equipment.sprzet_zgrany_id}
                                                            className={`${equipment.sprzet_zgrany_na_statku === "true" || equipment.sprzet_zgrany_na_statku === 1 ? "text-black" : "text-red-600"} border-b border-gray-200 hover:bg-gray-50`}>
                                                                ...
                                                                {globalEditMode ? (
                                                                    <div className="flex flex-col space-y-1">
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            className="border rounded-md px-2 py-1 w-full text-sm my-1"
                                                                        >
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            className="border rounded-md px-2 py-1 w-full text-sm mt-1"
                                                                        >
                                                                            <option value="">Na statku spis podstawowy?</option>
                                                                            <option value="true">Tak</option>
                                                                            <option value="false">Nie</option>
